...
/*   Updated: 2023/02/27 20:40:45 by mdi-paol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_correct_push_a(t_list **stack_a, t_list **stack_b, int index, t_data *data)
{
	...
	if (flag == 0)
		ft_case_both_positive_pa(stack_a, stack_b, index, data);
	if (flag == 1)
		ft_case_both_negative_pa(stack_a, stack_b, index, data);
	if (flag == 2)
		ft_case_positive_negative_pa(stack_a, stack_b, index, data);
	if (flag == 3)
		ft_case_negative_positive_pa(stack_a, stack_b, index, data);
}
